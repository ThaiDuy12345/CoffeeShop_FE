...
export class MappingService {
  ...
  ordering(payload: any): Ordering {
    return payload ? {
      ...
      account: this.account(payload.account),
      discount: this.discount(payload.discount)
    } : new Ordering()
  }
  ...
  product(payload: any): Product {
    return payload ? {
      ...
      category: this.category(payload.category),
  ...
  productSize(payload: any): ProductSize {
    return payload ? {
      ...
      product: this.product(payload.product)
    } : new ProductSize()
  }
}